...
def user_profile(user):
  user_record = usercol.find_one({"name": user})
  return render_template('profile.html', current_user=session['user']['name'], user_uploads=user_record["uploads"], other_user=user)
